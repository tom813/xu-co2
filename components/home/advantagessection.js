...
const AdvantagesSection = () => {
    return (
        <section style={{
            height: "fit-content", width: "100%", minWidth: "0", minHeight: "0"
        }} >
            <Flex w="full" h="60%" justifyContent="center" alignItems="center" flexDirection="column" zIndex="2" p="20px">
                ...
                <Flex h="300px" w="full" zIndex="2" flexWrap="wrap" justifyContent="center" flex="1 1" rowGap="60px" columnGap="20px">
